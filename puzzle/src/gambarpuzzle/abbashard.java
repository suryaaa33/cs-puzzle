...
public class abbashard extends JFrame{
    ...
    private void initUI() {
        ...
        try {
            ...
            Logger.getLogger(abbashard.class.getName()).log(
    ...
    private BufferedImage loadImage() throws IOException {
        ...
        BufferedImage bimg = ImageIO.read(new File("src/gambarpuzzle/abbaspuzzle.jpeg"));
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(() -> {
            abbashard puzzle = new abbashard();
